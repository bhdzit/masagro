<div class="container-fluid ">
	   <div id="arb-page" onclick="showMenu()"> <a href="#" class="fas fa-bars "><i></i></a></div>
			<header class="arb-maxagro-titel row p-0">
			<img class="col-2 d-none d-md-block col-md-2 p-0" src="<?php echo SERVERURL?>view/img/logo_recta_2.png">
